...
public class CatalogQuerierTest : BaseTestRoot
{
    ...
    [SetUp]
    public void Setup() {
        catalog1 = UriUtils.Resolve(TEST_ROOT_DIRECTORY, "XmlResolver/UnitTests/resources/lookup1.xml");
        catalog2 = UriUtils.Resolve(TEST_ROOT_DIRECTORY, "XmlResolver/UnitTests/resources/lookup2.xml");
    ...
    public void Undelegated()
    {
        ...
        uconfig.AddCatalog(catalog2, UriUtils.GetStream(catalog2));
